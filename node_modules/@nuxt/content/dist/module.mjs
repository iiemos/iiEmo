import fs from 'fs';
import { useLogger, defineNuxtModule, createResolver, addPlugin, addAutoImport, addComponentsDir, addTemplate, resolveModule } from '@nuxt/kit';
...
const version = "2.1.0-27680354.5a64f46";
