...
import { a as gray, c as cyan, u as underline, b as bold } from '../shared/nuxi-edge.d36337ed.mjs';
...
async function getSelfSignedCert(opts = {}) {
  const { generate } = await import('./index2.mjs').then(function (n) { return n.i; });
