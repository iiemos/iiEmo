...
import { l as lib } from '../shared/nuxi-edge.201b95ae.mjs';
import { s as splitByCase } from '../shared/nuxi-edge.18487058.mjs';
import clipboard from './browser.mjs';
import { g as getPackageManager, a as getPackageManagerVersion } from '../shared/nuxi-edge.abaa0182.mjs';
import { f as findup } from '../shared/nuxi-edge.3196727a.mjs';
...
function getNuxtConfig(rootDir) {
  try {
    return lib(rootDir, { interopDefault: true, esmResolve: true })("./nuxt.config");
  } catch (err) {
    return {};
  }
}
