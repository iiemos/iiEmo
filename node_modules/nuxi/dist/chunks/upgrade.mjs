...
import { i as isAbsolute$1, r as resolve, j as join } from '../shared/nuxi-edge.a03f3b10.mjs';
import require$$0$1, { existsSync, realpathSync, statSync, Stats, promises } from 'fs';
import { builtinModules } from 'module';
import { pathToFileURL, fileURLToPath as fileURLToPath$1, URL as URL$1 } from 'url';
import { j as joinURL } from '../shared/nuxi-edge.bf594194.mjs';
import require$$1 from 'path';
import require$$0 from 'assert';
import { format, inspect } from 'util';
import { g as getPackageManager, p as packageManagerLocks } from '../shared/nuxi-edge.abaa0182.mjs';
import { r as rmRecursive, t as touchFile } from '../shared/nuxi-edge.3196727a.mjs';
import { c as cleanupNuxtDirs, n as nuxtVersionToGitIdentifier } from '../shared/nuxi-edge.e9487964.mjs';
...
function isErrorStackTraceLimitWritable$1() {
  ...
  return own$1$1.call(desc, "writable") ? desc.writable : desc.set !== void 0;
}
...
const captureLargerStackTrace$1 = hideStackFrames$1(
  function(error) {
    ...
    if (stackTraceLimitIsWritable) {
      Error.stackTraceLimit = userStackTraceLimit$1;
    }
    return error;
  }
);
...
function read(jsonPath) {
  return find(require$$1.dirname(jsonPath));
}
function find(dir) {
  try {
    const string = require$$0$1.readFileSync(
      require$$1.toNamespacedPath(require$$1.join(dir, "package.json")),
      "utf8"
    );
    return { string };
  } catch (error) {
...
function defaultGetFormat(url) {
  ...
  if (parsed.protocol === "file:") {
    const ext = require$$1.extname(parsed.pathname);
    let format;
    if (ext === ".js") {
