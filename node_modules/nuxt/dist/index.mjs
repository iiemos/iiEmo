...
import { kebabCase, splitByCase, pascalCase } from 'scule';
...
const version = "3.0.0-rc.8-27681070.ad63817";
...
async function initNitro(nuxt) {
  ...
  const nitroConfig = defu(_nitroConfig, {
    ...
    prerender: {
      ...
      routes: [].concat(nuxt.options._generate ? ["/", ...nuxt.options.generate.routes] : []).concat(nuxt.options.ssr === false ? ["/", "/200.html", "/404.html"] : [])
    },
    sourcemap: nuxt.options.sourcemap,
    externals: {
      inline: [
...
const serverPluginTemplate = {
  ...
  getContents(ctx) {
    ...
    const exports = ["preload"];
    const imports = ["import preload from '#app/plugins/preload.server'"];
