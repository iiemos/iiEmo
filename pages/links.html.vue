...
useHead({
  ...
  meta:[
    ...
    { hid: 'description', name: 'description', content: '关于一朵大呲花的友情链接' },
  ]
})
</script>
<template>
  <NuxtLayout>
    <div :class="$style['iiemo_links']" class="container mx-auto mb-6 mt-10">
      <div :class="$style['_link_box']">
        <h1 :class="$style['_links_title']" class="text-xl font-semibold mb-10">
          ...
          >
            ...
            <div :class="$style['_item_bottom']" class="mt-4">
              <span
                ...
                >{{ lItem.lab }}</span
              >
              <div :class="$style['_link_time']" class="text-sm">
                添加时间： {{ lItem.addTime }}
              </div>
            </div>
          </nuxt-link>
      ...
      <div :class="$style['_link_box']" class="mt-10">
        <h1 :class="$style['_links_title']" class="text-xl font-semibold mb-10">
          开源镜像站<span class="text-sm ml-1">(9)</span>
        </h1>
        <div :class="$style['_links_warp']" class="">
          <nuxt-link
